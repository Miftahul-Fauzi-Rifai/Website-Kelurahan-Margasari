...
/* ==== ANNOUNCEMENTS HERO SECTION SLIDESHOW ==== */
...
.announcements-hero-section .hero-bg, 
.announcements-hero-section .hero-bg-next {
    position: absolute;
    inset: 0;
...
.announcements-hero-section::after {
    content: "";
    position: absolute;
    inset: 0;
...
window.addEventListener("load", function () {
    const hero = document.getElementById("announcements-hero");
    if (!hero) return;
